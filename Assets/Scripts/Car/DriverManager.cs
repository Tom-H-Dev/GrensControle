...
public class DriverManager : MonoBehaviour
{
    ...
    private static List<string> _driverFirstNameMale = new List<string>() { "Pieter", "Jan", "Dirk", "Willem", "Hans", "Rutger", "Joris", "Bas", "Marco", "Frank", "Robert", "Edwin", "Patrick", "Ronald", "Daniel", "Erik", "Kevin", "Raymond", "Stefan", "Mark", "Tom", "Ahmad", "Mohammed", "Abdul", "Hichem", "Yeshir", "Finn", "Ruben", "Zhahir", "Vins", "Rico", "Bon", "Luuk", "Tim", "Roel", "Michael", "Bert", "floris", "Peter", "Sander", "Yorick", "Harm", "Dennis", "Gerrit", "Coen", "Sander", "Thijs", "Wouter"};
    private static List<string> _driverFirstNameFemale = new List<string>() { "Anna", "Marie", "Petra", "Ingrid", "Yvonne", "Bianca", "Saskia", "Linda", "Miranda", "Deborah", "Sharon", "Vanessa", "Jessica", "Samantha", "Irene", "Esther", "Nicole", "Kimberley", "Amanda", "Nathalie", "Luca", "Kim", "Nomi", "Maud", "Anouk", "Margot", "Femke", "Jolanda", "Vera", "Floor", "Lotte", "Jolanda", "Marjolein", "Paulien", "Wendy", "Roos", "Foor", "Noa", "Ilse", "Elisa", "Tessa", "Iris", "Eline" };
    private static List<string> _driverLastNames = new List<string>() { "de Jong", "Jansen", "van Dijk", "Smit", "de Vries", "Peters", "Molenaar", "Kroon", "de Bruijn", "Blok", "Visser", "Boer", "Meijer", "Bakker", "de Wit", "Dekker", "Wolf", "Kwakman", "van Den Berg", "De Haas", "Holewijn", "Kortekaas", "Lambooij", "Kossen", "Krijgsman", "Alkaf", "Pol", "Verhoeven", "Hollemans","Veken", "Tkachov", "De groot", "Vos", "Van Leeuwen", "Kuiper", "Verhoeven", "De Boer", "Bakker", "van Vliet", "Schippers", "van Loon", "Heemskerk", "Hermans", "van Dam", "Verhoeven", "van Rossem", "de Koning", "Hoogendoorn" };
    ...
    private static List<char> _buildingNames = Enumerable.Range('A', 26).Select(x => (char)x).ToList();
    ...
    private static List<string> _driverRanks = new List<string> { "Sergeant", "Sergeant-Majoor", "Adjudant", "Adjudant-Onderofficier", "Tweede Luitenant", "Eerste Luitenant", "Kapitein", "Majoor", "Luitenant-Kolonel", "Kolonel"};
    private static List<string> _timeOnBaseTimes = new List<string>{"kwartiertje", "half uur", "zo'n drie kwartier", "één uur", "één uur en een kwartier", "anderhalf uur", "zo'n vijf uur", "maar twee uurtjes", "8 en een half uur", "zes uurtjes", "ongeveer vier uur", "drie uur", "drie uur en vijftien minuten", "drie uur en dertig minuten", "drie uur en vijfenveertig minuten","vier uur", "vier uur en vijftien minuten", "vier en een half uur", "ongeveer vier uur en drie kwartier","vijf uurjes", "vijf uur en vijftien minuten", "vijf uur en dertig minuten", "vijf uur en vijfenveertig minuten","zes uur", "zes uur en vijftien minuten", "zes uur en dertig minuten", "zes uur en vijfenveertig minuten","zeven uur", "zeven uur en vijftien minuten", "zeven uur en dertig minuten", "zeven uur en vijfenveertig minuten","acht uur", "acht uur en vijftien minuten", "acht uur en dertig minuten", "acht uur en vijfenveertig minuten","negen uur", "negen uur en vijftien minuten", "negen uur en dertig minuten", "zo'n negen uur helaas","tien uur"};
